...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        public async Task<ActionResult> CreateMessage(CreateMessageDto createMessageDto)
        {
            ...
            if (await _messageRepository.SaveAllChanges()) return Ok(_mapper.Map<MessageDto>(message));
        ...
        public async Task<ActionResult> DeleteMessage(int id)
        {
            ...
            if (message.SenderUsername != username && message.Recipient.UserName != username) return Unauthorized();
            ...
            if (await _messageRepository.SaveAllChanges()) return Ok();
